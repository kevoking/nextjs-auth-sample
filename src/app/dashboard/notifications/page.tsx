      ...
      <div className="grid gap-4 place-items-center min-h-[400px]">
        <div className="text-center space-y-4">
          <div className="flex justify-center">
            <IconNotification className="h-16 w-16 text-muted-foreground" />
          </div>
          <div className="space-y-2">
            <h2 className="text-xl font-semibold">Notification Center</h2>
            <p className="text-muted-foreground max-w-md">
              Coming soon! Customize your notification preferences, manage alerts, and stay updated with important information.
            </p>
          </div>
        </div>
      </div>
